...
std::string eris_h_src = R"VOG0N(#ifndef ERIS_H
#define ERIS_H
...
void transpile(const std::string& in_filename, const std::string& out_filename, const std::string& text) {
   ...
   std::string sPath = idx == std::string::npos ? "." : in_filename.substr(0, idx) + "/include";
    ...
    std::ofstream eris_h_file;
    eris_h_file.open(idx == std::string::npos ? "." : in_filename.substr(0, idx) + "/include/eris.h");
    eris_h_file << eris_h_src;
