...
namespace tachyon {
    ...
    public:
        ...
        void visit_int_node(const std::shared_ptr<IntNode>& node);
        void visit_float_node(const std::shared_ptr<FloatNode>& node);
        ...
        void visit_for_stmt_node(const std::shared_ptr<WhileStmtNode>& node);
